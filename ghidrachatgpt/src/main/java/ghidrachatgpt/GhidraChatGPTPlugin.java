...
public class GhidraChatGPTPlugin extends ProgramPlugin {
	...
	private int OPENAI_MAX_TOKENS = 250;
	...
	public void identifyFunction() {
		...
		result = askChatGPT(String.format(GCG_IDENTIFY_STRING, decResult.decompiledFunc));
		if (result == null)
			return;
	...
	public void findVulnerabilities() {
		...
		result = askChatGPT(String.format(GCG_VULNERABILITY_STRING, decResult.decompiledFunc));
		if (result == null)
			return;
	...
	public void beautifyFunction() {
		...
		result = askChatGPT(String.format(GCG_BEAUTIFY_STRING, decResult.decompiledFunc));
		if (result == null)
			return;
